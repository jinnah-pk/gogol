...
--
-- /See:/ <https://cloud.google.com/document-ai/docs/ Cloud Document AI API Reference>
module Gogol.DocumentAI
    (
    -- * Configuration
      documentAIService
    ...
    , DocumentAIProjectsLocationsProcessorsProcessResource
    , DocumentAIProjectsLocationsProcessorsProcess (..)
    , newDocumentAIProjectsLocationsProcessorsProcess
    ...
    , DocumentAIProjectsLocationsProcessorsProcessorVersionsProcessResource
    , DocumentAIProjectsLocationsProcessorsProcessorVersionsProcess (..)
    , newDocumentAIProjectsLocationsProcessorsProcessorVersionsProcess

    -- ** documentai.projects.locations.processors.processorVersions.undeploy
    , DocumentAIProjectsLocationsProcessorsProcessorVersionsUndeployResource
    , DocumentAIProjectsLocationsProcessorsProcessorVersionsUndeploy (..)
    , newDocumentAIProjectsLocationsProcessorsProcessorVersionsUndeploy
...
import Gogol.DocumentAI.Projects.Locations.FetchProcessorTypes
import Gogol.DocumentAI.Projects.Locations.Get
import Gogol.DocumentAI.Projects.Locations.List
import Gogol.DocumentAI.Projects.Locations.Operations.Cancel
import Gogol.DocumentAI.Projects.Locations.Operations.Get
import Gogol.DocumentAI.Projects.Locations.Operations.List
import Gogol.DocumentAI.Projects.Locations.Processors.BatchProcess
import Gogol.DocumentAI.Projects.Locations.Processors.Create
import Gogol.DocumentAI.Projects.Locations.Processors.Delete
import Gogol.DocumentAI.Projects.Locations.Processors.Disable
import Gogol.DocumentAI.Projects.Locations.Processors.Enable
import Gogol.DocumentAI.Projects.Locations.Processors.Get
import Gogol.DocumentAI.Projects.Locations.Processors.HumanReviewConfig.ReviewDocument
import Gogol.DocumentAI.Projects.Locations.Processors.List
import Gogol.DocumentAI.Projects.Locations.Processors.Process
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.BatchProcess
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.Delete
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.Deploy
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.Get
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.List
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.Process
import Gogol.DocumentAI.Projects.Locations.Processors.ProcessorVersions.Undeploy
import Gogol.DocumentAI.Projects.Locations.Processors.SetDefaultProcessorVersion
